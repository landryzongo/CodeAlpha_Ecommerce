...
const Login = () => {
    ...
    const getPasswordStrength = (password) => {
        ...
        const levels = [
            ...
            { score: 5, label: 'Très fort', color: '#667eea' },
        ];
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[#94a3b8] text-[14px] font-normal">
                                {isLogin
                                    ...
                                    : 'Sign up to get started with NovaTech.'}
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-[20px]">
                        {!isLogin && (
                            <div className="flex flex-col gap-2">
                                <label className="text-[14px] font-normal text-slate-300">Name</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-[14px] font-normal text-slate-300">Email</label>
                            <div className="relative group">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-center">
                                <label className="text-[14px] font-normal text-slate-300">Password</label>
                                {isLogin && (
